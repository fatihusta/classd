...
psql -U postgres uvm -c "update settings.u_mail_settings set from_address = 'mspx@mspx.example.com'"
psql -U postgres uvm -c "update settings.u_address_settings set hostname = 'mspx.example.com'"
